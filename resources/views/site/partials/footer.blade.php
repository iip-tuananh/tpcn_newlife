                    ...
                    <div class="list-menu">
                        <div class="group-address">
                            <ul>
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="var(--mainColor)">
                                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18a2 2 0 0 0 2 2h16c1.1 0 2-.9 2-2V6a2 2 0 0 0-2-2zm0 14H4V6h16v12zM6 12h5v2H6zm0-4h12v2H6z"/>
                                    </svg>

                                    <a class="tel" href="javascript:void(0)" title="MST: {{ $config->tax_code }}">MST:
                                        {{ $config->tax_code }}</a>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
